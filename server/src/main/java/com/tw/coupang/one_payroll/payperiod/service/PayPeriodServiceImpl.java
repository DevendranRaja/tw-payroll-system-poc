...
public class PayPeriodServiceImpl implements PayPeriodService {
    ...
    public PayPeriodServiceImpl(PayPeriodRepository payPeriodRepository,
                                ...
                                PayPeriodCycleValidator payPeriodCycleValidator) {
    ...
    @Override
    public Integer getPayPeriodId(Integer payGroupId, LocalDate startDate, LocalDate endDate) {
        return payPeriodRepository.findPayPeriodId(payGroupId, startDate, endDate)
